        ...
        <div key={appt.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-4 transition hover:shadow-md">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800">{appt.doctor?.user?.name || "Doctor"}</h3>
          ...
          {reviewingId === appt.id && (
            <div className="pt-4 mt-2 border-t border-gray-100 animate-fadeIn">
              <h4 className="text-sm font-bold text-gray-800 mb-2">Rate your experience with{appt.doctor?.user?.name}</h4>
